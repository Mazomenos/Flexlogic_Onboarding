    ...
    <>
      ...
      >
        <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex w-screen items-center justify-center p-4">
          <DialogPanel className="bg-base-100 dark:bg-darkMode-base-100 border-base-200 dark:border-darkMode-base-200 max-h-[90%] md:max-h-[90%] lg:max-h-[80%] xl:max-h-[80%] 2xl:max-h-[70%] relative w-full max-w-3xl  flex flex-col items-center overflow-y-auto overscroll-none border text-primary-content dark:text-darkMode-foreground p-12 pb-6">
            {children}
